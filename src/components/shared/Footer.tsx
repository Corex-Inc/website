      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          <div className="md:col-span-1 flex flex-col">
            <Link to="/" className="inline-flex items-center gap-3 mb-6 group">
              ...
              <span className="text-xl font-bold text-white tracking-tight font-unbounded">Corex</span>
            </Link>
          ...
          <FooterColumn title="Corex">
            ...
            <FooterLink href="/meta" external>Meta Docs</FooterLink>
            <FooterLink href="https://modrinth.com/plugin/corex.cx" external>Download</FooterLink>
            <FooterLink href="/@@@">VSCode Extension</FooterLink>
          </FooterColumn>

          <FooterColumn title="Community">
            <FooterLink href="https://dsc.gg/corexinc">Discord</FooterLink>
            <FooterLink href="https://t.me/corexinc">Telegram</FooterLink>
            <FooterLink href="https://modrinth.com/plugin/corex.cx">Modrinth</FooterLink>
            <FooterLink href="https://github.com/Corex-Inc/Corex/issues">Issues</FooterLink>
          </FooterColumn>
        ...
        <div>
          ...
          <div className="flex items-center gap-4">
            <a href="/documents/terms" className="hover:text-gray-300 transition-colors">Terms of Service</a>
            <span className="text-gray-700">•</span>
            <a href="/documents/privacy" className="hover:text-gray-300 transition-colors">Privacy Policy</a>
            <span className="text-gray-700">•</span>
            <a href="/documents/eula" className="hover:text-gray-300 transition-colors">EULA</a>
          </div>
        </div>
      </div>
